          ...
          <Col xs={12} sm={12} md={6} lg={4} xl={4} className="card-container">
            <Card style={{ width: "30rem" }}>
              ...
              <Card.Body className="card-body">
                ...
                <a href="https://ball-it.netlify.app/">
                  <Button className="btn bg-light shadow button3">
                    Visit Web
                  </Button>
                </a>
              </Card.Body>
          ...
          <Col xs={12} sm={12} md={6} lg={4} xl={4} className="card-container">
            <Card style={{ width: "30rem" }}>
              ...
              <Card.Body className="card-body">
                ...
                <a href="https://rent-a-car-ks.netlify.app/">
                  <Button className="btn bg-light shadow button3">
                    Visit Web
                  </Button>
                </a>
          ...
          <Col xs={12} sm={12} md={6} lg={4} xl={4} className="card-container">
            <Card style={{ width: "30rem" }}>
              ...
              <Card.Body className="card-body">
                <Card.Title>Rent a Car</Card.Title>
                <Card.Text>
                  This Project is made with HTML, Css, JavaScript, Bootstrap and
                  PHP.
                </Card.Text>
                <a href="https://libelium-sensors.000webhostapp.com/">
                  <Button className="btn bg-light shadow button3">
                    Visit Web
                  </Button>
                </a>
